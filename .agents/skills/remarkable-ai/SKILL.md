...
- `rm-ai devices`: List or switch active tablet.
- `rm-ai add-device`: Register a new tablet.
- `rm-ai setup`: Automatically install AI skills and slash commands for Antigravity, Gemini, and Claude.
